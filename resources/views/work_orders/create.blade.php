...
@section('content')
    ...
    <div class="card" style="max-width: 800px;">
        <form id="work-order-create-form" action="{{ route('work-orders.store') }}" method="POST">
            @csrf
    ...
    <script>
        const formId = 'work-order-create-form';
        const storageKey = 'work_order_create_draft';
